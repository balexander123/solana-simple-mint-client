...
const tokenName = "Growers"
const description = "Growers holders are part of our grow!"
const symbol = "GROW"
const decimals = 2
const amount = 1
...
async function main() {
  ...
  // file to buffer
  const buffer = fs.readFileSync("assets/plant.png")

  // buffer to metaplex file
  const file = toMetaplexFile(buffer, "plant.png")
